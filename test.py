# Project Title: DOCUMENTING AUTHORSHIP WITH VS CODE SNIPPETS
# Project Description: MEDIUM.COM Article
# Author:  Matthew E. Miller
# Date: 02/01/2020 12:40:24
...
# (c) Copyright by Matthew E. Miller and Associates
